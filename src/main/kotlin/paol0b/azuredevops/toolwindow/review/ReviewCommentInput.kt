...
/**
 * IntelliJ-native text input used by review comments.
 *
 * EditorTextField uses the IDE editor's input-method handling, which is important
 * for CJK composition inside a JBPopup on Windows.
 */
